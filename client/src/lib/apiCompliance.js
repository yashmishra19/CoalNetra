/**
 * Compliance API – live obligations, regulator directions.
...
export async function getLicencesAndClearances() {
  // Licence table not yet seeded – return static placeholder
  return [
    { id: 'lc-1', title: 'Consent to Operate – MPCB', issuer: 'MPCB', validUntil: '10 Nov 2026', status: 'ACTIVE' },
    { id: 'lc-2', title: 'Explosive Licence – PESO', issuer: 'PESO Nagpur', validUntil: '31 Mar 2027', status: 'ACTIVE' },
    { id: 'lc-3', title: 'Mining Lease – MoM', issuer: 'Ministry of Mines', validUntil: '12 Jun 2036', status: 'ACTIVE' },
  ];
}
