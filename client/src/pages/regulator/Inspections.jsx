  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-24 text-status-neutral gap-3">
        ...
        <span className="text-[14px]">Loading inspections data...</span>
      </div>
    );
  }
  ...
  if (error || !data) {
    return (
      <div className="py-12 text-center text-status-critical text-[14px]">
        {error || 'Unable to load inspections data.'}
      </div>
    );
  }
    ...
    <div className="w-full font-sans">
      ...
      <div className="mt-2 flex flex-col md:flex-row md:items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-3 flex-wrap sm:flex-nowrap">
          ...
          <button className="bg-status-info text-white rounded-lg px-5 py-2.5 text-[13px] font-semibold hover:bg-status-info-dark transition cursor-pointer whitespace-nowrap">
            ...
            <div key={kpi.id} className="bg-white border border-page-border rounded-xl p-4 flex flex-col justify-between">
              <div>
                ...
                <div className="mt-2 flex items-baseline gap-1.5">
                  ...
                  {kpi.suffix && (
                    <span className="text-[15px] text-status-neutral font-medium">
                      {kpi.suffix}
                    </span>
                  )}
                </div>
