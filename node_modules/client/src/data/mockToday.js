/**
 * Mock data for the 'Today' dashboard page
 */
...
export const mockTodayData = {
    ...
    items: [
      {
        ...
        actions: [
          { label: 'Verify', variant: 'dark-blue' },
      ...
      },
      {
        ...
        actions: [
          { label: 'Reassign', variant: 'dark-blue' },
      ...
      },
      {
        ...
        timeInfo: {
          primary: '4 h',
          secondary: 'work starts 20:30',
          variant: 'warning',
        },
        actions: [
          { label: 'Approve', variant: 'dark-blue' },
    ...
    rankedItems: [
      {
        ...
        name: 'Dump-3',
        detail: 'Slope moving 4.2 mm/day after 118 mm rain',
      },
      {
        rank: 2,
        score: 74,
        ...
        detail: 'Accident yesterday, berm CAPA open',
      },
      {
        rank: 3,
        score: 66,
        badgeVariant: 'warning',
        name: 'Bench 4, coal face',
        detail: 'Not inspected yet this shift',
      },
    ],
  },
  ...
  deadlines: {
    hours24: {
      ...
      items: [
        {
          title: 'Serious accident notice to DGMS',
          due: '22:02 today',
          isCritical: true,
        },
        {
          title: 'Verify CAPA-231',
          due: '18:20 today',
          isCritical: false,
        },
        {
          title: 'Hot-work permit decision',
          due: '20:30 today',
          isCritical: false,
        },
      ],
  ...
  liveReadings: [
    ...
    },
    {
      ...
      value: '6 of 8',
      note: 'sprinklers running',
      status: 'warning',
    },
    {
      id: 'dump3-radar',
      label: 'Dump-3 slope radar',
      value: '4.2 mm/day',
      note: 'alert at 5',
      status: 'warning',
    },
    {
      id: 'sump-water',
      label: 'Sump-1 water level',
      value: '62%',
      note: '2 of 3 pumps on',
      status: 'good',
    },
    {
      id: 'haul-traffic',
      label: 'Haul road traffic',
      value: '34 dumpers',
      note: '2 over speed in last hour',
      status: 'warning',
    },
  ],
  ...
  fieldFeed: [
    {
      ...
      time: '16:12',
      author: 'B. Oraon',
      action: 'logged a safety observation: loose material on Bench 3 edge.',
      detail: 'Classified as ground control, medium. CAPA-240 created.',
      tag: 'GPS verified',
      tagVariant: 'gps-verified',
    },
    {
      id: 'feed-2',
      time: '15:58',
      author: 'M. Hansda',
      action: 'recorded PM10 reading at AQ-2 by voice note in Hindi.',
      detail: 'Transcribed and matched to sensor value.',
      tag: 'GPS verified',
      tagVariant: 'gps-verified',
    },
    {
      ...
      time: '15:41',
      author: 'A. Kujur',
      action: 'uploaded after-photos for CAPA-231.',
      detail: 'Photo hash recorded at capture.',
      tag: 'GPS verified',
      tagVariant: 'gps-verified',
    },
    {
      ...
      time: '15:20',
      author: 'S. Ekka',
      action: 'inspected Sump-1 electrical panel.',
      detail: 'All 14 checklist items OK.',
      tag: 'QR tag',
      tagVariant: 'qr-tag',
    },
    {
